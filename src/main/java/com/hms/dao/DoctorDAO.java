...
public class DoctorDAO {
	...
	public boolean registerDoctor(Doctor doctor) {
		...
		try {
			...
			String sql = "insert into doctor(full_name,dob,qualification,specialist_id,email,mobno,password) values(?,?,?,?,?,?,?)";
	...
	public List<Doctor> getAllDoctor() {
		...
		try {
			...
			while (resultSet.next()) {
				...
				doctor.setSpecialist(resultSet.getString("specialist_id"));
	...
	public boolean updateDoctor(Doctor doctor) {
		...
		try {
			...
			String sql = "update doctor set full_name=?,dob=?,qualification=?,specialist_id=?,email=?,mobno=?,password=? where id=?";
	...
	public boolean editDoctorProfile(Doctor doctor) {
		...
		try {
			...
			String sql = "update doctor set full_name=?,dob=?,qualification=?,specialist_id=?,email=?,mobno=? where id=?";
